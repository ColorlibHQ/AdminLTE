...
3. Compile dist files (Development) :
    ...
    * Make your changes are only in ./buid Folder OR package.json OR ./dist/js/demo.js OR in any html files which are necessary to contribute to
    * Do not make changes in ./dist/css/ AND ./dist/js/ Because it contains compiled files
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/ColorlibHQ/AdminLTE)
