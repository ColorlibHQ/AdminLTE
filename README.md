...
**Note:** -- This repo is font awesome and other all yarn packages updated version of AdminLTE. Also, all old class name of font awesome is changed with their new class name. Happy Coding !
