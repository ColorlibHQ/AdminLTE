...
(function (global, factory) {
  ...
  var Fullscreen = /*#__PURE__*/function () {
    function Fullscreen(_element, _options) {
      ...
      this.options = $__default.extend({}, Default$4, _options);
    } // Public
    ...
    _proto.fullscreen = function fullscreen() {
      ...
      $__default(SELECTOR_ICON).removeClass(this.options.maximizeIcon).addClass(this.options.minimizeIcon);
    };
    ...
    _proto.windowed = function windowed() {
      ...
      $__default(SELECTOR_ICON).removeClass(this.options.minimizeIcon).addClass(this.options.maximizeIcon);
    } // Static
    ;
    ...
    Fullscreen._jQueryInterface = function _jQueryInterface(config) {
      ...
      var _options = $__default.extend({}, Default$4, typeof config === 'object' ? config : data);

      var plugin = new Fullscreen($__default(this), _options);
      $__default(this).data(DATA_KEY$6, typeof config === 'object' ? config : data);
  ...
  $__default(document).on('click', SELECTOR_DATA_WIDGET, function () {
    Fullscreen._jQueryInterface.call($__default(this), 'toggle');
  });
  /**
   * jQuery API
   * ====================================================
  ...
  $__default.fn[NAME$6] = Fullscreen._jQueryInterface;
  $__default.fn[NAME$6].Constructor = Fullscreen;
  ...
  $__default.fn[NAME$7] = Layout._jQueryInterface;
  $__default.fn[NAME$7].Constructor = Layout;
  ...
  var PushMenu = /*#__PURE__*/function () {
    function PushMenu(element, options) {
      this._element = element;
      this._options = $__default.extend({}, Default$6, options);
    ...
    PushMenu._jQueryInterface = function _jQueryInterface(operation) {
      return this.each(function () {
        ...
        var _options = $__default.extend({}, Default$6, $__default(this).data());
  ...
  $__default.fn[NAME$8] = PushMenu._jQueryInterface;
  $__default.fn[NAME$8].Constructor = PushMenu;
  ...
  var SidebarSearch = /*#__PURE__*/function () {
    function SidebarSearch(_element, _options) {
      this.element = _element;
      this.options = $__default.extend({}, Default$7, _options);
      this.items = [];
    } // Public
    ...
    _proto.init = function init() {
      ...
      if ($__default(SELECTOR_DATA_WIDGET$1).next(SELECTOR_SEARCH_RESULTS).length == 0) {
        $__default(SELECTOR_DATA_WIDGET$1).after($__default('<div />', {
    ...
    _proto.open = function open() {
      $__default(SELECTOR_DATA_WIDGET$1).parent().addClass(CLASS_NAME_OPEN$1);
      $__default(SELECTOR_SEARCH_ICON).removeClass(CLASS_NAME_ICON_SEARCH).addClass(CLASS_NAME_ICON_CLOSE);
    };

    _proto.close = function close() {
      $__default(SELECTOR_DATA_WIDGET$1).parent().removeClass(CLASS_NAME_OPEN$1);
      $__default(SELECTOR_SEARCH_ICON).removeClass(CLASS_NAME_ICON_CLOSE).addClass(CLASS_NAME_ICON_SEARCH);
    };

    _proto.toggle = function toggle() {
      if ($__default(SELECTOR_DATA_WIDGET$1).parent().hasClass(CLASS_NAME_OPEN$1)) {
        this.close();
      } else {
        this.open();
      }
    ...
    SidebarSearch._jQueryInterface = function _jQueryInterface(config) {
      var data = $__default(this).data(DATA_KEY$9);

      if (!data) {
        data = $__default(this).data();
      }

      var _options = $__default.extend({}, Default$7, typeof config === 'object' ? config : data);

      var plugin = new SidebarSearch($__default(this), _options);
      $__default(this).data(DATA_KEY$9, typeof config === 'object' ? config : data);
  ...
  $__default(document).on('click', SELECTOR_SEARCH_BUTTON, function (event) {
    ...
    SidebarSearch._jQueryInterface.call($__default(SELECTOR_DATA_WIDGET$1), 'toggle');
  });
  $__default(document).on('keyup', SELECTOR_SEARCH_INPUT, function (event) {
    if (event.keyCode == 38) {
      event.preventDefault();
      $__default(SELECTOR_SEARCH_RESULTS_GROUP).children().last().focus();
      return;
    }

    if (event.keyCode == 40) {
      event.preventDefault();
      $__default(SELECTOR_SEARCH_RESULTS_GROUP).children().first().focus();
      return;
    }
    ...
    timer = setTimeout(function () {
      SidebarSearch._jQueryInterface.call($__default(SELECTOR_DATA_WIDGET$1), 'search');
    }, 100);
  });
  $__default(document).on('keydown', SELECTOR_SEARCH_RESULTS_GROUP, function (event) {
    var $focused = $__default(':focus');
  ...
  $__default(window).on('load', function () {
    SidebarSearch._jQueryInterface.call($__default(SELECTOR_DATA_WIDGET$1), 'init');
  });
  /**
   * jQuery API
   * ====================================================
  ...
  $__default.fn[NAME$9] = SidebarSearch._jQueryInterface;
  $__default.fn[NAME$9].Constructor = SidebarSearch;
  ...
  var Toasts = /*#__PURE__*/function () {
    ...
    Toasts._jQueryInterface = function _jQueryInterface(option, config) {
      return this.each(function () {
        var _options = $__default.extend({}, Default$8, config);
  ...
  $__default.fn[NAME$a] = Toasts._jQueryInterface;
  $__default.fn[NAME$a].Constructor = Toasts;
  ...
  $__default.fn[NAME$b] = TodoList._jQueryInterface;
  $__default.fn[NAME$b].Constructor = TodoList;
  ...
  var JQUERY_NO_CONFLICT$c = $__default.fn[NAME$c];
  ...
  var Treeview = /*#__PURE__*/function () {
    ...
    Treeview._jQueryInterface = function _jQueryInterface(config) {
      return this.each(function () {
        var data = $__default(this).data(DATA_KEY$c);

        var _options = $__default.extend({}, Default$a, $__default(this).data());

        if (!data) {
          data = new Treeview($__default(this), _options);
          $__default(this).data(DATA_KEY$c, data);
        }
  ...
  $__default(window).on(EVENT_LOAD_DATA_API, function () {
    $__default(SELECTOR_DATA_WIDGET$2).each(function () {
  ...
  $__default.fn[NAME$c] = Treeview._jQueryInterface;
  $__default.fn[NAME$c].Constructor = Treeview;

  $__default.fn[NAME$c].noConflict = function () {
    $__default.fn[NAME$c] = JQUERY_NO_CONFLICT$c;
