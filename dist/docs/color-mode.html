            ...
            >
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../docs/javascript/sidebar-search.html" class="nav-link">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Sidebar Search</p>
                    </a>
                  </li>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Color Mode Toggle</h1>
              </div>
              <div class="col-sm-6">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p>The mode is resolved from three sources, in this order:</p>
                    <ol>
                      <li>
                        <strong>The visitor’s stored choice</strong> —
                        <code>localStorage.lte-theme</code>, written when they click a toggle. It is
                        their own click on this device, so it wins.
                      </li>
                      <li>
                        <strong>The theme your page declared</strong> —
                        <code>data-bs-theme</code> on <code>&lt;html&gt;</code> as it was served.
                        Use this to render a per-user preference from a cookie or a user record; it
                        survives OS preference changes.
                      </li>
                      <li>
                        <strong>The OS preference</strong> — <code>prefers-color-scheme</code>,
                        followed live while neither of the above expressed a choice.
                      </li>
                    </ol>
                    <p>
                      Only <code>light</code>, <code>dark</code> and <code>auto</code> are
                      understood. A custom Bootstrap theme name in <code>data-bs-theme</code> is not
                      a mode ColorMode can resolve, so it is ignored — see
                      <em>Opting out</em> below.
                    </p>
...
<span class="line"></span>
<span class="line"><span style="color:#9CDCFE">colorMode</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">getPreferredTheme</span><span style="color:#D4D4D4">() </span><span style="color:#6A9955">// &quot;light&quot; | &quot;dark&quot; | &quot;auto&quot; — the effective choice</span></span>
<span class="line"><span style="color:#9CDCFE">colorMode</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">getStoredTheme</span><span style="color:#D4D4D4">()    </span><span style="color:#6A9955">// what the visitor picked, or null</span></span>
<span class="line"><span style="color:#9CDCFE">colorMode</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">getMarkupTheme</span><span style="color:#D4D4D4">()    </span><span style="color:#6A9955">// what the page declared on &lt;html&gt;, or null</span></span>
...
<span class="line"><span style="color:#569CD6">    const</span><span style="color:#4FC1FF"> root</span><span style="color:#D4D4D4"> = </span><span style="color:#9CDCFE">document</span><span style="color:#D4D4D4">.</span><span style="color:#9CDCFE">documentElement</span></span>
<span class="line"><span style="color:#C586C0">    if</span><span style="color:#D4D4D4"> (</span><span style="color:#9CDCFE">root</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">getAttribute</span><span style="color:#D4D4D4">(</span><span style="color:#CE9178">&quot;data-lte-color-mode&quot;</span><span style="color:#D4D4D4">) === </span><span style="color:#CE9178">&quot;off&quot;</span><span style="color:#D4D4D4">) </span><span style="color:#C586C0">return</span></span>
...
<span class="line"><span style="color:#569CD6">    const</span><span style="color:#4FC1FF"> authored</span><span style="color:#D4D4D4"> = </span><span style="color:#9CDCFE">root</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">getAttribute</span><span style="color:#D4D4D4">(</span><span style="color:#CE9178">&quot;data-bs-theme&quot;</span><span style="color:#D4D4D4">)</span></span>
<span class="line"><span style="color:#569CD6">    let</span><span style="color:#9CDCFE"> resolved</span><span style="color:#D4D4D4"> = </span><span style="color:#CE9178">&quot;light&quot;</span></span>
<span class="line"><span style="color:#C586C0">    if</span><span style="color:#D4D4D4"> (</span><span style="color:#9CDCFE">stored</span><span style="color:#D4D4D4"> === </span><span style="color:#CE9178">&quot;dark&quot;</span><span style="color:#D4D4D4"> || </span><span style="color:#9CDCFE">stored</span><span style="color:#D4D4D4"> === </span><span style="color:#CE9178">&quot;light&quot;</span><span style="color:#D4D4D4">) </span><span style="color:#9CDCFE">resolved</span><span style="color:#D4D4D4"> = </span><span style="color:#9CDCFE">stored</span></span>
<span class="line"><span style="color:#C586C0">    else</span><span style="color:#C586C0"> if</span><span style="color:#D4D4D4"> (</span><span style="color:#9CDCFE">authored</span><span style="color:#D4D4D4"> === </span><span style="color:#CE9178">&quot;dark&quot;</span><span style="color:#D4D4D4"> || </span><span style="color:#9CDCFE">authored</span><span style="color:#D4D4D4"> === </span><span style="color:#CE9178">&quot;light&quot;</span><span style="color:#D4D4D4">) </span><span style="color:#9CDCFE">resolved</span><span style="color:#D4D4D4"> = </span><span style="color:#9CDCFE">authored</span></span>
<span class="line"><span style="color:#C586C0">    else</span><span style="color:#C586C0"> if</span><span style="color:#D4D4D4"> (</span><span style="color:#DCDCAA">matchMedia</span><span style="color:#D4D4D4">(</span><span style="color:#CE9178">&quot;(prefers-color-scheme: dark)&quot;</span><span style="color:#D4D4D4">).</span><span style="color:#9CDCFE">matches</span><span style="color:#D4D4D4">) </span><span style="color:#9CDCFE">resolved</span><span style="color:#D4D4D4"> = </span><span style="color:#CE9178">&quot;dark&quot;</span></span>
<span class="line"><span style="color:#9CDCFE">    root</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">setAttribute</span><span style="color:#D4D4D4">(</span><span style="color:#CE9178">&quot;data-bs-theme&quot;</span><span style="color:#D4D4D4">, </span><span style="color:#9CDCFE">resolved</span><span style="color:#D4D4D4">)</span></span>
<span class="line"><span style="color:#9CDCFE">    root</span><span style="color:#D4D4D4">.</span><span style="color:#9CDCFE">style</span><span style="color:#D4D4D4">.</span><span style="color:#9CDCFE">colorScheme</span><span style="color:#D4D4D4"> = </span><span style="color:#9CDCFE">resolved</span></span>
<span class="line"><span style="color:#C586C0">    if</span><span style="color:#D4D4D4"> (</span><span style="color:#9CDCFE">resolved</span><span style="color:#D4D4D4"> !== </span><span style="color:#9CDCFE">authored</span><span style="color:#D4D4D4">) </span><span style="color:#9CDCFE">root</span><span style="color:#D4D4D4">.</span><span style="color:#DCDCAA">setAttribute</span><span style="color:#D4D4D4">(</span><span style="color:#CE9178">&quot;data-lte-theme-resolved&quot;</span><span style="color:#D4D4D4">, </span><span style="color:#CE9178">&quot;&quot;</span><span style="color:#D4D4D4">)</span></span>
...
<span class="line"><span style="color:#808080">&lt;/</span><span style="color:#569CD6">script</span><span style="color:#808080">&gt;</span></span></code></pre>
                    <p>
                      It follows the same precedence as the module, so a theme you rendered
                      server-side is not overwritten before paint. The last line matters: it flags a
                      value the snippet worked out itself, so the module doesn’t mistake it for a
                      theme your page declared and stop following the OS preference.
                    </p>
                    <h5 id="server-rendered-themes">Server-rendered themes</h5>
                    <p>
                      If you store a per-user preference server-side, render it on
                      <code>&lt;html&gt;</code> and the module will keep it — on load, and across OS
                      preference changes:
                    </p>
                    <pre
                      class="astro-code dark-plus"
                      ...
                      tabindex="0"
                      data-language="html"
                    ><code><span class="line"><span style="color:#808080">&lt;</span><span style="color:#569CD6">html</span><span style="color:#9CDCFE"> lang</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;en&quot;</span><span style="color:#9CDCFE"> data-bs-theme</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;dark&quot;</span><span style="color:#808080">&gt;</span></span></code></pre>
                    <p>
                      It remains a default: the moment a visitor clicks a toggle, their choice is
                      persisted and takes precedence on that device from then on. Clear
                      <code>lte-theme</code> from <code>localStorage</code> when you want the
                      server’s value to take over again.
                    </p>
                    <h5 id="opting-out">Opting out</h5>
                    <p>
                      Applications with their own theming — a custom Bootstrap theme, or a switcher
                      of your own — turn the module off entirely:
                    </p>
                    <pre
                      class="astro-code dark-plus"
                      style="background-color: #1e1e1e; color: #d4d4d4; overflow-x: auto"
                      tabindex="0"
                      data-language="html"
                    ><code><span class="line"><span style="color:#808080">&lt;</span><span style="color:#569CD6">html</span><span style="color:#9CDCFE"> lang</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;en&quot;</span><span style="color:#9CDCFE"> data-lte-color-mode</span><span style="color:#D4D4D4">=</span><span style="color:#CE9178">&quot;off&quot;</span><span style="color:#808080">&gt;</span></span></code></pre>
                    <p>
                      ColorMode then never writes <code>data-bs-theme</code>: not on load, not when
                      a <code>[data-bs-theme-value]</code> toggle is clicked, and not when the OS
                      preference changes. The inline snippet above honours it too, so nothing
                      touches your theme before first paint either. Your own code stays in full
                      control of <code>&lt;html data-bs-theme&gt;</code>.
                    </p>
