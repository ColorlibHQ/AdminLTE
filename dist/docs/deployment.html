      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Deployment &amp; Performance</h1>
              </div>
              <div class="col-sm-6">
...
<span class="line"><span>└── assets/             ← demo images / fonts (replace with your own)</span></span></code></pre>
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Select2 theme <em>(optional)</em></td>
                          <td><code>dist/css/adminlte-select2.css</code></td>
                          <td>
                            <strong><code>dist/css/adminlte-select2.min.css</code></strong>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <p>
                      <code>adminlte-select2.css</code> is opt-in and only needed if your app loads
                      <a href="integrations.html#select2-compatibility-theme">Select2</a>; it is not
                      part of <code>adminlte.css</code>. <code>adminlte-docs.css</code> styles the
                      documentation pages only — never ship it.
                    </p>
