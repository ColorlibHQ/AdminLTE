      ...
      <main class="app-main">
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6">
                <h1 class="mb-0 fs-3">RTL Support</h1>
              </div>
              <div class="col-sm-6">
...
<span class="line"><span>dist/css/adminlte.rtl.min.css</span></span></code></pre>
                    <p>
                      Optional stylesheets get the same treatment — the
                      <a href="integrations.html#select2-compatibility-theme"
                        >Select2 compatibility theme</a
                      >, for instance, ships as <code>adminlte-select2.rtl.css</code> /
                      <code>.rtl.min.css</code> alongside its LTR build.
                    </p>
                    <p>
