          ...
          <div class="container-fluid">
            ...
            <section class="faq-hero text-center mb-4">
              ...
              <p class="faq-hero-lead">
                Quick answers to the 23 questions we get asked most often. Use the search to jump to
            ...
            <nav class="faq-chips mb-4" aria-label="FAQ sections">
              <a href="#getting-started" class="faq-chip faq-chip-primary">
                ...
                <span class="faq-chip-count">5</span> </a
              ...
              ><a href="#troubleshooting" class="faq-chip faq-chip-danger">
                ...
                <span class="faq-chip-count">6</span>
              </a>
            </nav>
                ...
                <div class="faq-section-items">
                  ...
                  <details class="faq-item" data-faq-item>
                    ...
                    <div class="faq-answer">
                      ...
                      shims.<br /><br />The v3 <code>plugins/</code> folder is gone too. Every
                      widget it bundled has a vanilla-JS successor — see the
                      <a href="migration.html#third-party-plugin-replacements"
                        >plugin replacement table</a
                      >
                  ...
                  <details class="faq-item" data-faq-item>
                    <summary>
                      ...
                      <span class="faq-q-text">Does AdminLTE 4 support Select2?</span>
                      <span class="faq-q-chevron">
                        <i class="bi bi-chevron-down" aria-hidden="true"></i>
                      </span>
                    </summary>
                    <div class="faq-answer">
                      AdminLTE 4 recommends
                      <a href="https://tom-select.js.org/" target="_blank" rel="noopener"
                        >Tom Select</a
                      >
                      instead. It covers everything people reach for Select2 to do — searchable
                      dropdowns, multi-select, tagging, clearable selections, AJAX-backed options,
                      virtual scrolling over large datasets, keyboard navigation — in roughly
                      <strong>20&nbsp;kB gzip</strong>, against Select2's
                      <strong>~50&nbsp;kB</strong> once jQuery is counted.
                      <code>forms/advanced.html</code> demos all of it, including a paginated
                      remote-data field with request cancellation, and there's a
                      <a href="../forms/advanced.html#select2">line-by-line API mapping</a> if
                      you're porting existing code.<br /><br />Select2 itself is still maintained
                      (4.1.0 shipped in 2026), but it is still a jQuery plugin — its UMD wrapper
                      hard-requires jQuery and there is no jQuery-free build. Bundling it would put
                      jQuery back into a framework whose entire v4 premise is not needing it, and
                      none of the official Vue/React/Django/Laravel ports could consume it.<br /><br />If
                      you're locked into Select2 anyway, AdminLTE ships an optional
                      <strong>styling-only</strong> compatibility sheet — see
                      <a href="integrations.html#select2-compatibility-theme"
                        >Select2 compatibility theme</a
                      >. You bring the plugin; it makes Select2 match Bootstrap 5.3, dark mode and
                      modals included. No jQuery is added to AdminLTE.
                    </div>
                  </details>
                </div>
              </section>
              ...
              <section id="troubleshooting" class="faq-section" data-faq-section>
                <header class="faq-section-header faq-section-danger">
                  ...
                  <div>
                    ...
                    <p class="faq-section-count">6 questions</p>
                  </div>
                </header>
                <div class="faq-section-items">
                  <details class="faq-item" data-faq-item>
                  ...
                  <details class="faq-item" data-faq-item>
                    <summary>
                      ...
                      <span class="faq-q-text"
                        >My own theming keeps getting overwritten by AdminLTE.</span
                      >
                      <span class="faq-q-chevron">
                        <i class="bi bi-chevron-down" aria-hidden="true"></i>
                      </span>
                    ...
                    <div class="faq-answer">
                      Turn the bundled switcher off with
                      <code>&lt;html data-lte-color-mode="off"&gt;</code>. ColorMode then never
                      writes <code>data-bs-theme</code> — not on load, not on a toggle click, not
                      ...
                      instead, render <code>data-bs-theme</code> on <code>&lt;html&gt;</code> and it
                      is respected as long as the visitor hasn't picked a theme themselves. See
                      <a href="color-mode.html">Color Mode</a>.
                    </div>
                  </details>
                  <details class="faq-item" data-faq-item>
                    <summary>
