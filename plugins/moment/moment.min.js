!(function (e, t) {
  ...
  var Te = "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diciembre".split(
      "_"
    ),
  ...
  var Ze = "Domingo_Lunes_Martes_Miércoles_Jueves_Viernes_Sábado".split(
    ...
    $e = "Do_Lu_Ma_Mx_Ju_Vi_Sa".split("_"),
    qe = de,
    Be = de,
    Je = de;
  function Qe() {
  ...
  var ft = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
    ...
    wt = /^\/?Date\((-?\d+)/i,
    pt = /^(?:(Lun|Mar|Mie|Jue|Vie|Sab|Dom),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/,
    vt = {
      UT: 0,
      GMT: 0,
      EDT: -240,
